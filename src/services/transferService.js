  ...
  try {
    ...
    return {
      ...
      sender: {
        ...
        transaction_reference: senderTransaction.reference_number,
        balance_before: parseFloat(senderBalance).toFixed(2),
        balance_after: parseFloat(newSenderBalance).toFixed(2),
      },
      receiver: {
        account_number: receiver.account_number,
        name: `${receiver.first_name} ${receiver.last_name}`,
        transaction_reference: receiverTransaction.reference_number,
        balance_before: parseFloat(receiverBalance).toFixed(2),
        balance_after: parseFloat(newReceiverBalance).toFixed(2),
      },
